    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task7()
        {
            IEnumerable<object> result = Emps.GroupBy(emp => emp.Job)
                                            .Select(e => new { Praca = e.Key, LiczbaPracowników = e.Count() });
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps.Join(
                    ...
                    emp => emp.Deptno,
                    dept => dept.Deptno,
                    (emp, dept) => new { dept.Dname, emp.Empno })
                .GroupBy(d => d.Dname)
                .Where(g => g.Count() > 1)
                .Select(g => new
                {
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts.GroupJoin(
                    ...
                    dept => dept.Deptno,
                    emp => emp.Deptno,
                    (dept, emps) => new { Dept = dept, Count = emps.Count() })
        ...
        public static IEnumerable<Dept> Task15()
        {
            IEnumerable<Dept> result = Emps.Where(emp => emp.Job.Contains('A'))
                ...
                .Select(g => new Dept { Dname = g.Key, Deptno = -1, Loc = null });
            return result;
        }
